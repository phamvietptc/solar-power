      ...
      <RecentPosts blogs={allBlogs} /> */}
                      ...
                      <div className=" w-full h-full inline-block relative overflow-hidden ">
                        ...
                        <div className=" max-w-950px mx-auto px-10px ">
                          <div className=" absolute top-1/2 w-full left-0 text-center -translate-y-1/2 ">
                            <h2></h2>
                            <a href="#" className=" leading-3 text-sm py-5px px-15px text-white text-center min-w-120px font-normal uppercase inline-block relative overflow-hidden z-40 rounded-3xl bg-gradient-to-r bg-transparent from-orange-600 to-orange-400 cursor-pointer ">Khám phá hệ sinh thái năng lượng Solarht</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className=" items-center h-auto flex flex-wrap w-full bg-white rounded-10px justify-center ">
                      <div className=" p-10px w-calc-20px flex items-center float-left h-full relative ">
                        <div className=" w-full h-full inline-block ">
                          <a className=" text-orange-500 absolute w-full h-full top-0 left-0 z-50 cursor-pointer bg-transparent " href="https://www.youtube.com/watch?v=h6-VubFRoIM"></a>
                          <img src="/images/home/video.png" alt="video" className=" h-full object-cover max-h-165px max-w-full rounded-10px " />
                          <a href="#" className=" w-10 h-10 border border-solid border-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full z-10 text-orange-500 bg-transparent cursor-pointer ">
                      ...
                      <div className=" w-calc-20px p-10px flex items-center text-center justify-center float-left h-full relative ">
                        <div className=" inline-block ">
                          <div className=" mb-10px w-full float-left relative top-2 ">
                            <img src="/images/home/energy.png" alt="icon" className=" h-30px inline-block " />
                          </div>
                          <div className=" float-none ">
                            <h3 className=" text-sm text-blue-500 uppercase mb-10px font-normal ">800MW</h3>
                            <p className=" text-10px leading-normal text-slate-900 uppercase ">TỔNG CÔNG SUẤT</p>
                          </div>
                        </div>
                      </div>
                      <div className=" w-calc-20px p-10px flex items-center text-center justify-center float-left h-full relative ">
                        <div className=" inline-block ">
                          <div className=" mb-10px w-full float-left relative top-2 ">
                            <img src="/images/home/system.png" alt="icon" className=" h-30px inline-block " />
                          </div>
                          <div className=" float-none ">
                            <h3 className=" text-sm text-blue-500 uppercase mb-10px font-normal ">10.000+</h3>
                            <p className=" text-10px leading-normal text-slate-900 uppercase ">HỆ THỐNG</p>
                          </div>
                        </div>
                      </div>
                      <div className=" w-calc-20px p-10px flex items-center text-center justify-center float-left h-full relative ">
                        <div className=" inline-block ">
                          <div className=" mb-10px w-full float-left relative top-2 ">
                            <img src="/images/home/partner.png" alt="icon" className=" h-30px inline-block " />
                          </div>
                          <div className=" float-none ">
                            <h3 className=" text-sm text-blue-500 uppercase mb-10px font-normal ">1.800+</h3>
                            <p className=" text-10px leading-normal text-slate-900 uppercase ">ĐỐI TÁC PHÂN PHỐI</p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className=" max-w-950px mx-auto px-10px before:content-['.'] before:block before:overflow-hidden before:invisible before:w-0 before:h-0 ">
                  <div className=" w-full flex justify-center mb-30px text-center float-left px-10px before:content-['.'] before:block before:overflow-hidden before:invisible before:w-0 before:h-0 after:clear-both ">
                    <div className=" text-13px ">
                      <h2 className=" text-xl text-slate-900 font-normal uppercase leading-1.2 font-segoe mb-5 ">VỀ SOLAR HT</h2>
                      <p className=" text-justify mb-6 text-slate-900 ">SOLAR HT là Tập đoàn công nghệ – thương mại dịch vụ có quy mô, uy tín dẫn đầu Việt Nam trong lĩnh vực tự động hóa công nghiệp và năng lượng tái tạo. Trong đó, Solar ht chuyên về mảng điện năng lượng mặt trời – lưu trữ điện, không ngừng tiên phong kiến tạo Hệ sinh thái, gia tăng hiệu quả, mang đến giá trị tối ưu cho khách hàng, đối tác.</p>
                      <div className=" text-sm leading-22px text-left pl-15px border-l-8 border-solid border-slate-100 inline-block mb-50px mt-10px text-slate-900 text-justify ">
                        Solar ht đã cung cấp và triển khai hơn <b>10.000 hệ thống</b> điện mặt trời có tổng công suất hơn <b>800MWp</b>, mang đến cho khách hàng, đối tác và nhà đầu tư những giải pháp điện mặt trời thông minh, tối ưu chi phí đầu tư nhưng vẫn đảm bảo tính hiệu quả cao.
                      </div>
                    </div>
                  </div>
                  <div className=" w-full flex justify-center mb-30px text-center float-left px-10px before:content-['.'] before:block before:overflow-hidden before:invisible before:w-0 before:h-0 after:clear-both ">
                    <div className=" relative ">
                      ...
                      <div className=" pt-0 pr-10 pb-5 pl-30px bg-linear-gradient text-white absolute -bottom-35px -left-35px max-w-290px before:absolute before:right-0 before:border-b-0 before:bg-[url('/images/home/before_right.png')] before:content-[''] before:w-158px before:h-152px before:bottom-0 ">
                        <span className=" text-50px font-segoe leading-normal font-normal uppercase ">17+</span>
                ...
                <div className=" max-w-950px mx-auto px-10px before:content-['.'] before:block before:overflow-hidden before:invisible before:w-0 before:h-0 after:clear-both ">
                  ...
                  <div className=" pt-10 w-full flex flex-wrap text-sm mb-30px float-left before:content-['.'] before:block before:overflow-hidden before:invisible before:w-0 before:h-0 after:clear-both ">
                    <h2 className=" w-full text-center text-xl text-slate-900 font-segoe font-normal uppercase leading-1.2 px-10px ">
                      GIẢI PHÁP ĐIỆN<br className=" hidden " /> MẶT TRỜI
                      <p className=" text-13px inline-block text-slate-900 leading-1.2 font-segoe my-5 normal-case ">Solar HT hiểu rõ những lợi ích của việc ứng dụng nguồn năng lượng sạch vào nhiều lĩnh vực khác nhau của cuộc sống.</p>
                    </h2>
                    <p className=" hidden mb-5 ">Solar HT hiểu rõ những lợi ích của việc ứng dụng nguồn năng lượng sạch vào nhiều lĩnh vực khác nhau của cuộc sống.</p>
              ...
              <section className=" bg-[url('/images/home/bg.jpeg')] pt-50px w-screen relative -ml-50vw left-1/2 overflow-hidden bg-no-repeat bg-cover ">
                <div className=" text-center px-10px text-sm max-w-600px mx-auto ">
                  <h2 className=" text-white text-xl font-segoe font-normal uppercase mb-5 leading-tight ">DỰ ÁN ĐÃ THỰC HIỆN</h2>
