  ...
  return (
    <>
      <header className=" border-b border-solid border-blue-500 fixed w-full z-50 h-60px text-center bg-white top-0 ">
        <div className=" md:p-0 md:max-w-7xl max-w-950px pl-5 mx-auto text-center ">
          ...
          <nav className=" md:float-right md:clear-right bg-transparent float-none clear-both text-center ">
            <div className=" md:max-w-7xl float-right max-w-950px relative px-0 mx-auto ">
            ...
            <div className=" md:hidden inline-block w-10 h-10 bg-blue-600 leading-10 text-center absolute right-5 top-10px text-white "></div>
          </nav>
        </div>
      </header>
    </>
