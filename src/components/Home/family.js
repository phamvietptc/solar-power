            ...
            <div className=" duration-200 animate-opa ">
                <div className=" min-h-450px relative ">
                    ...
                    <div className=" md:text-left md:pt-140px md:pl-140px text-13px p-30px text-center relative z-20 text-white ">
                        ...
                        <h3 className=" md:text-3xl text-15px uppercase mb-5 leading-tight font-normal ">ĐIỆN MẶT TRỜI CHO<br />HỘ GIA ĐÌNH</h3>
                        <p className=" md:text-17px mb-6 ">Giải pháp không chỉ mang đến nguồn năng lượng sạch thân thiện với môi trường mà còn tạo ra hiệu quả kinh tế cao cho gia đình Việt, tiết kiệm đáng kể chi phí tiền điện hằng tháng.</p>
