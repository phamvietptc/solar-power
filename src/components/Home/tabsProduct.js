...
const TabsProduct = () => {
  ...
  return (
    <>
      ...
      <div className=" w-full md:w-70% max-h-300px md:max-h-400px relative overflow-hidden float-left px-10px md:pl-14 md:pr-0 before:content-['.'] before:overflow-hidden before:invisible before:w-0 before:h-0 after:clear-both ">
