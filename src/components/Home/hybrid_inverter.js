                    ...
                    <div className=" w-full flex justify-center ">
                      <div className=" flex flex-wrap min-h-150px p-3 rounded-10px border border-solid border-slate-50 bg-white my-2px shadow-rgba08 relative ">
                        <div className=" w-full float-left text-center ">
                          <img
                            src={item.image}
                            className=" h-20 md:h-32 max-h-150px inline-block "
                            alt="image"
                          />
                        </div>
                        <div className=" w-full pt-10px text-center float-left ">
                          <h3 className=" text-lg text-slate-900 leading-5 font-segoe mb-10px font-normal normal-case ">
                            {item.product}
                          </h3>
                          <h4 className=" line-clamp-2 h-10 text-13px text-slate-900 leading-5 uppercase mb-15px ">
                            {item.introduce}
                          </h4>
                          <p className=" text-13px text-slate-900 leading-5 ">
                            Công suất: <b>{item.wattage}</b>
                          </p>
                          <p className=" text-13px text-slate-900 leading-5 ">
                            Hãng: <b>{item.manufacturer}</b>
                          </p>
                        </div>
                        <a
                          href="#"
                          className=" absolute left-0 top-0 w-full h-full bg-transparent "
                        ></a>
                      </div>
                    </div>
                  </div>
