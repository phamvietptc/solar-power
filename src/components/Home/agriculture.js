            ...
            <div className=" duration-200 animate-opa ">
                <div className=" min-h-450px relative ">
                    ...
                    <div className=" text-13px p-30px text-center relative z-20 text-white ">
                        ...
                        <h3 className=" text-15px uppercase mb-5 leading-tight font-normal ">ĐIỆN MẶT TRỜI CHO<br />NÔNG NGHIỆP</h3>
                        <p className=" mb-6 ">Ứng dụng cho lĩnh vực nông nghiệp, đảm bảo nguồn nước cho việc tưới tiêu, các trạm bơm cấp nước</p>
